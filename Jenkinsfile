pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/plaughlc'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/loganplaugher/225-lab3-6.git'                                          //<------change this
        KUBECONFIG = credentials('plaughlc-225')                                                         //<------change this
    }
